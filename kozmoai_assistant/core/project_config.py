"""
Functions for reading and writing the `kozmoai-assistant.toml` configuration file.

The `kozmoai-assistant.toml` file is a TOML file that contains project-specific configuration used by the KOZMOAI Assistant CLI and gptengineer.app.
"""
...
default_config_filename = "kozmoai-assistant.toml"
...
[kozmoaiassistant-app]  # this namespace is used for kozmoaiassistant.app, may be used for internal experiments
project_id = "..."
...
@dataclass
class Config:
    """Configuration for the KOZMOAI Assistant CLI and gptengineer.app via `kozmoai-assistant.toml`."""
