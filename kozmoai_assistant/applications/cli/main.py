...
from kozmoai_assistant.applications.cli.cli_agent import CliAgent
from kozmoai_assistant.applications.cli.collect import collect_and_send_human_review
from kozmoai_assistant.applications.cli.file_selector import FileSelector
from kozmoai_assistant.core.ai import AI, ClipboardAI
from kozmoai_assistant.core.default.disk_execution_env import DiskExecutionEnv
from kozmoai_assistant.core.default.disk_memory import DiskMemory
from kozmoai_assistant.core.default.file_store import FileStore
from kozmoai_assistant.core.default.paths import PREPROMPTS_PATH, memory_path
from kozmoai_assistant.core.default.steps import (
    execute_entrypoint,
    gen_code,
    handle_improve_mode,
    improve_fn as improve_fn,
)
from kozmoai_assistant.core.files_dict import FilesDict
from kozmoai_assistant.core.git import stage_uncommitted_to_git
from kozmoai_assistant.core.preprompts_holder import PrepromptsHolder
from kozmoai_assistant.core.prompt import Prompt
from kozmoai_assistant.tools.custom_steps import clarified_gen, lite_gen, self_heal
...
def load_prompt(
    ...
    if prompt_str:
        ...
        if not improve_mode:
            prompt_str = input(
                "\nWhat application do you want kozmoai-assistant to generate?\n"
            )
        else:
...
def main(
    ...
    print("Running kozmoai-assistant in", path.absolute(), "\n")
