...
It operates within the KOZMOAI-Assistant environment, relying on core functionalities for
...
from kozmoai_assistant.core.default.paths import metadata_path
from kozmoai_assistant.core.files_dict import FilesDict
from kozmoai_assistant.core.git import filter_by_gitignore, is_git_repo
...
class FileSelector:
    ...
    COMMENT = (
        ...
        "# kozmoai-assistant can only read selected files. "
