...
for the purpose of analysis and to improve the kozmoai-assistant system. The data is sent
...
Dependencies:
    ...
    kozmoai_assistant.core: Core functionalities of kozmoai-assistant.
    kozmoai_assistant.cli.learning: Handles the extraction of learning data.

Notes:
    Data sent to RudderStack is not shared with third parties and is used solely to
    improve kozmoai-assistant and allow it to handle a broader range of use cases.
    Consent logic is in kozmoai_assistant/learning.py.
"""

from typing import Tuple

from kozmoai_assistant.applications.cli.learning import (
    Learning,
    Review,
    extract_learning,
    human_review_input,
...
def send_learning(learning: Learning):
    ...
    improving kozmoai-assistant, and letting it handle more use cases.
    Consent logic is in kozmoai_assistant/learning.py.
    """
