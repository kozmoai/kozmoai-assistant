...
import kozmoai_assistant.applications.cli.main as main

from kozmoai_assistant.applications.cli.main import load_prompt
...
class TestMain:
    #  Runs kozmoai-assistant cli interface for many parameter configurations, BUT DOES NOT CODEGEN! Only testing cli.
    ...
    #  Runs kozmoai-assistant with improve mode and improves an existing project in the specified path.
    ...
    #  Runs kozmoai-assistant with lite mode and generates a project with only the main prompt.
    ...
    #  Runs kozmoai-assistant with clarify mode and generates a project after discussing the specification with the AI.
    ...
    #  Runs kozmoai-assistant with self-heal mode and generates a project after discussing the specification with the AI and self-healing the code.
...
class TestLoadPrompt:
    ...
    def test_load_prompt_no_file_improve_mode_false(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            with patch(
                "builtins.input",
                return_value="What application do you want kozmoai-assistant to generate?",
            ):
                result = load_prompt(
...
#         monkeypatch.setattr("builtins.input", lambda _: next(gen))
#         monkeypatch.setattr(
#             "kozmoai_assistant.core.default.steps.salvage_correct_hunks",
